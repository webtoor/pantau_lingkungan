...
@Component({
  selector: 'app-pantau-investasi',
  templateUrl: './pantau-investasi.page.html',
  styleUrls: ['./pantau-investasi.page.scss'],
})
export class PantauInvestasiPage implements OnInit {
  capturedSnapURL = ''
  latitude
  longitude
  accuracy
